 ...
 * @date 2018/6/5下午4:17
 */
public class MidClientHandler extends SimpleChannelInboundHandler<ByteBuf> {

    private Logger logger = LoggerFactory.getLogger(MidClientHandler.class);
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, ByteBuf in){
        ...
        if(future != null){
            ...
            future.done(ress[1]);
            logger.info("MidClient receive data from PA:"+ress[0]+","+ress[1]);
        }
    }
}
